...
function bagA(data) {
  ...
  return [secHeader("BAGIAN A - IDENTITAS MATA PELAJARAN", C.navyMid), pEmpty(80), t];
}
...
function bagB(data) {
  ...
  return [secHeader("BAGIAN B - RINGKASAN CAPAIAN PEMBELAJARAN", C.navyMid), pEmpty(80), t];
}
...
function bagC(tps) {
  ...
  return [
    secHeader("BAGIAN C - TABEL TUJUAN PEMBELAJARAN (TP)", C.tealDark), pEmpty(80),
...
function bagD(tps) {
  ...
  const t = new Table({ width: { size: CONTENT_W, type: WidthType.DXA }, columnWidths: W, rows });
  return [secHeader("BAGIAN D - INDIKATOR KETERCAPAIAN (IKTP) & ASESMEN", C.tealDark), pEmpty(80), t];
}

function bagE(data, notes) {
  ...
  return [secHeader("BAGIAN E - CATATAN PENGEMBANGAN DAN VALIDASI TP", C.orangeDark), pEmpty(80), t1, pEmpty(120), t2];
}
    ...
    sections: [
      ...
      // ── HALAMAN 2 (PORTRAIT): TP ──
      {
        ...
        children: [
          ...
          pEmpty(120),
          ...bagA(data), pEmpty(120),
          ...bagB(data), pEmpty(120),
          ...bagC(aiData.tujuanPembelajaran), pEmpty(120),
          ...bagD(aiData.tujuanPembelajaran), pEmpty(120),
          ...bagE(data, aiData.catatan), pEmpty(120)
        ],
      },
