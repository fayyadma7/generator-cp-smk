...
function p(text, opts = {}) {
  const {
    ...
    color = C.textDark, align = AlignmentType.BOTH,
...
function pMulti(runs, opts = {}) {
  const { align = AlignmentType.BOTH, spBefore = 40, spAfter = 40 } = opts;
  return new Paragraph({
    alignment: align,
    spacing: { before: spBefore, after: spAfter },
...
function pMarkdown(text, opts = {}) {
  const { align = AlignmentType.BOTH, spBefore = 40, spAfter = 40, ...rest } = opts;
