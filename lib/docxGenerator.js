...
function makeBagian4(data, aiData) {
  ...
  return [
    bannerTable("BAGIAN II \u2014 DOKUMEN UTAMA GURU", C.tealDark, C.white, 26,
...
function makeBagian5() {
  ...
  return [
    bannerTable("BAGIAN III \u2014 ALUR PENGGUNAAN DOKUMEN CP", C.purpleMid, C.white, 22,
...
export async function generateAndDownloadDocx(data, aiData) {
  const doc = new Document({
    ...
    sections: [
      ...
      // ── HALAMAN 3+: Bagian II (Format Isian Guru) ──
      {
        properties: { page: { size: { width: PAGE_W, height: PAGE_H }, margin: { top: MARGIN, right: MARGIN, bottom: MARGIN, left: MARGIN } } },
        children: [...makeBagian4(data, aiData), pEmpty(120)],
      },
      // ── HALAMAN TERAKHIR: Bagian III (Alur) ──
      {
        properties: { page: { size: { width: PAGE_W, height: PAGE_H }, margin: { top: MARGIN, right: MARGIN, bottom: MARGIN, left: MARGIN } } },
